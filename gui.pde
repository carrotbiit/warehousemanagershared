...
public void createGUI(){
  ...
  simSpeedSlider = new GCustomSlider(controls, 150, 266, 100, 50, "grey_blue");
  ...
  employeeWage = new GCustomSlider(controls, 275, 60, 100, 50, "purple18px");
  ...
  resetButton = new GButton(controls, 150, 6, 100, 30);
  ...
  speedLabel = new GLabel(controls, 150, 236, 100, 30);
  ...
  wageLabel = new GLabel(controls, 275, 42, 100, 20);
  ...
  applyChanges = new GButton(controls, 275, 6, 100, 30);
  applyChanges.setText("Apply Changes");
  applyChanges.addEventHandler(this, "applyChangesClicked");
  packageRequestSpeed = new GLabel(controls, 150, 53, 100, 30);
  ...
  packageRequestSpeedSlider = new GCustomSlider(controls, 150, 84, 100, 50, "red_yellow18px");
  ...
  gasPriceSlider = new GCustomSlider(controls, 275, 138, 100, 50, "purple18px");
  ...
  gasPriceLabel = new GLabel(controls, 275, 118, 100, 20);
  gasPriceLabel.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  gasPriceLabel.setText("Gasoline Price");
  gasPriceLabel.setOpaque(false);
  maxLoadSlider = new GCustomSlider(controls, 150, 175, 100, 50, "red_yellow18px");
  ...
  maxLoadLabel = new GLabel(controls, 150, 145, 100, 30);
  ...
  detailDrop = new GDropList(controls, 275, 214, 100, 80, 3, 10);
  detailDrop.setItems(loadStrings("list_359832"), 3);
  detailDrop.addEventHandler(this, "detailDropClicked");
  detailLabel = new GLabel(controls, 275, 194, 100, 20);
